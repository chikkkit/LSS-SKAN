...
# 单参数非线性函数
lfuns = ['FourierKAN', 'lshifted_softplus', 'waveKAN', 'fastKAN', 'efficientKAN', 'fkan', 'rkan']
...
print(device)
for lr in [*np.linspace(0.01, 0.09, 9), *np.linspace(0.001, 0.009, 9), *np.linspace(0.0001, 0.0009, 9)]:
    for lfun in lfuns:
        if lfun == 'waveKAN':
